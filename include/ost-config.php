...
define('SECRET_SALT','Ijbxw1sdE9qE0QiXnTKxxJVj7tD_0uny');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','bpalazzola@ymail.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','osticketdb-cluster.cluster-cy5io6jwl71e.us-east-1.rds.amazonaws.com');
define('DBNAME','osticketdb');
define('DBUSER','bpalazzola');
define('DBPASS','voteoften');
